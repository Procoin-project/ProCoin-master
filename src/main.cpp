...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Procoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Procoin: 2.5 minutes
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        //     CTxOut(nValue=50000.00000000, scriptPubKey=040184710fa689ad5023690c80f3a4)
